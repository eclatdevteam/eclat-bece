...
import { Sparkles, Zap, Target, Flame, Trophy, Award, ArrowUpRight, Share2 } from "lucide-react";
    ...
    <>
        ...
        <div className="flex items-center justify-between border-b border-border/60 pb-4 mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className="h-9 w-9 text-muted-foreground hover:text-foreground shrink-0 border-border/60"
      ...
      <SocialShareModal
        ...
        config={{
          ...
          headline: `SESSION REWARDS (+${totalSessionEP} EP)`,
          narrative: `Completed practice session with precision and earned +${totalSessionEP} Éclat Points advancing toward Level ${levelOutcome.level + 1}!`,
          rewardEP: totalSessionEP,
        }}
      />
    </>
  );
