...
export default function SchoolLogInPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Sign in to manage cohorts, quiz assignments & analytics"
      footerLink={{
        text: "Need to onboard your school?",
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        >
          {isLoading ? (
            ...
            <>
              Sign In to School Portal <ArrowRight className="ml-1.5 h-4 w-4" />
            </>
          )}
        </Button>
